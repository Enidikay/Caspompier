...
<body>
    ...
    <div class="flex h-full bg-gray-100">
        ...
        <main class="flex-grow p-8">
            ...
            $upload_directoryfolder = '../images/storedimage/';
            $upload_directorybdd = 'images/storedimage/';
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $imagebdd = $_FILES['image']['name'];
                $image_tmp = $_FILES['image']['tmp_name']; // Fichier temporaire téléchargé
                $movefile = move_uploaded_file($image_tmp, $upload_directoryfolder . $image);
                ...
                if ($existingEngin) {
                    ...
                    if ($movefile) {
                        ...
                        $nouvelEngin = new TypeEngin([
                            'Id' => $id,
                            'Libelle' => $libelle,
                            'Image' => $upload_directorybdd . $imagebdd // Utilisation du chemin de l'image
                        ]);
