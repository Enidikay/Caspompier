...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        // Redirige vers la page d'inscription OK
        echo '<meta http-equiv="refresh" content="0;url=inscriptionOK.php">';
    }
    ?>
    ...
    <div class="container mx-auto mt-10 w-full max-w-lg pb-10">
        <form method="post" action="#" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="date_naissance" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Date
                    de naissance</label>
            ...
            <div class="mb-4">
                <fieldset class="flex flex-row">
                    <legend class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sexe</legend>
            ...
            <div class="mb-4">
                <label for="telephone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Numéro de
                    téléphone</label>
            ...
            <div class="mb-4">
                <fieldset class="flex flex-row">
                    <legend class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Type de pompier
                    </legend>
                    <div class="flex items-center pr-5">
                    ...
                    <div class="flex items-center">
                        <input type="radio" id="volontaire" name="type_pompier" value="volontaire"
                            class="mr-2 text-pink-500 focus:ring-pink-500 dark:text-pink-400 dark:focus:ring-pink-400">
                        <label for="volontaire" class="text-sm text-gray-900 dark:text-gray-300">Volontaire</label>
                    </div>
                </fieldset>
            </div>
            ...
            <fieldset id="employeurFieldset" style="display: none;">
                ...
                <div class="mb-4">
                    <label for="bip" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Bip</label>
            ...
            <fieldset id="dateEmbaucheField" style="display: none;">
                <div class="mb-4">
                    <label for="date_embauche"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Date d'embauche</label>
